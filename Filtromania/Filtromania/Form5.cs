...
namespace Filtromania
{
    public partial class Form5 : Form
    {
        ...
        private void button7_Click(object sender, EventArgs e)
        {
            ...
            fotoEditada = frameActual.Bitmap;
        ...
        {
            MessageBox.Show("Gracias por usar nuestra app.", "Gracias", MessageBoxButtons.OK, MessageBoxIcon.Information);
            this.Close();
        }
        ...
        private void Convolucion4()
        {
            ...
            for (int x = 1; x < frameActual.Width - 1; x++)
            {
                for (int y = 1; y < frameActual.Height - 1; y++)
                {
                    ...
                    color1 = frameActual.Bitmap.GetPixel(x - 1, y - 1);
                    color2 = frameActual.Bitmap.GetPixel(x, y - 1);
                    color3 = frameActual.Bitmap.GetPixel(x + 1, y - 1);
                    color4 = frameActual.Bitmap.GetPixel(x - 1, y);
                    color5 = frameActual.Bitmap.GetPixel(x, y);
                    color6 = frameActual.Bitmap.GetPixel(x + 1, y);
                    color7 = frameActual.Bitmap.GetPixel(x - 1, y + 1);
                    color8 = frameActual.Bitmap.GetPixel(x, y + 1);
                    color9 = frameActual.Bitmap.GetPixel(x + 1, y + 1);
